export default function Spinner({ text = "Loading..." }) {
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center overflow-hidden bg-black gap-6">
      ...
      {/* Loading Text */}
      <p className="relative z-10 text-white/80 text-lg font-medium tracking-wide">
        {text}
      </p>
