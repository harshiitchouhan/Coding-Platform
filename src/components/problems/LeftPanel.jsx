...
export default function LeftPanel({
  ...
  return (
    <div>
      ...
      {activeTab === "description" && (
        <>
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            {problem.companies?.length > 0 && mode !== "contest" && (
          ...
          <div className="space-y-6">
            ...
            <Section title="Examples:">
              {problem.visibleTestCases?.map((ex, i) => (
                <div
                  key={i}
                  className="bg-[#111827] border text-base border-white/10 rounded-xl p-4 mt-3"
                >
            ...
            {problem.hints?.length > 0 && mode !== "contest" && (
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">
                      ...
                      <span
                        ...
                        className="text-purple-300 font-medium cursor-pointer"
                      >
                        BitMentor AI
                      </span>{" "}
                      for step-by-step explanations, hints, and debugging help.
                    </p>
                  </div>
                </div>
      ...
      {/* EDITORIAL - only practice */}
      {activeTab === "editorial" && mode !== "contest" && (
      ...
      {/* SOLUTIONS - only practice */}
      {activeTab === "solutions" && mode !== "contest" && (
        <div className="space-y-3">
      ...
      {/* AI Assistant - only practice */}
      {activeTab === "assistant" && mode !== "contest" && (
        <div className="h-165">
          <AIAssistant
            problem={problem}
            messages={aiMessages}
